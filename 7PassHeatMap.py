...
with open('Statsbomb/data/matches/'+str(competition_id)+'/26.json') as f:
    matches = json.load(f)
...
ax.set_title('Danger passes by ' + team_required+ 'in UCL 14-15')
fig.set_size_inches(10, 7)
fig.savefig('Output/PassesBy' + team_required + 'UCL14-15.pdf', dpi=100) 
plt.show()
...
ax.set_title('Danger passes per match in UCL 14- 15 by ' + team_required)
plt.xlim((-1,121))
plt.ylim((83,-3))
plt.tight_layout()
...
fig.savefig('Output/HeatmapOfPasses' + team_required + 'UCL14-15.pdf', dpi=None, bbox_inches="tight") 
