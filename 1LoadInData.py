...
print("La liga: " + str(competition_required_id))
...
for match in matches:
    ...
    if (home_team_name == "Arsenal") or (away_team_name == "Arsenal"):
...
for competition in competitions:
    ...
    if comp_name == competitions_name:
        competition_required_id = competition['competition_id']
print("World cup id: " + str(competition_required_id))

with open('Statsbomb/data/matches/'+str(competition_required_id)+'/30.json') as f:
    matches = json.load(f)
